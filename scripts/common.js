function changeBackground(id = -1) {
    ...
    */
    ...
    switch(id) {
        case 0:
            document.getElementById("home-background").setAttribute("src", backgrounds[0]);
            document.getElementById("home-background").setAttribute("alt", alts[0]);
            return;
        case 1:
            document.getElementById("home-background").setAttribute("src", backgrounds[1]);
            document.getElementById("home-background").setAttribute("alt", alts[1]);
            return;
        case 2:
            document.getElementById("home-background").setAttribute("src", backgrounds[2]);
            document.getElementById("home-background").setAttribute("alt", alts[2]);
            return;
    }
